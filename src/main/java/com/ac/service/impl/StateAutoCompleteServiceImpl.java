...
public class StateAutoCompleteServiceImpl implements AutoCompleteService<State> {
	...
	public void initCache() {
		...
		String maxItems;
		timeToLive = context.getEnvironment().getProperty("cache.state.timeToLive");
		if (timeToLive != null) {
			timerInterval = context.getEnvironment().getProperty("cache.state.timerInterval");
			maxItems = context.getEnvironment().getProperty("cache.state.maxItems");
		} else {
			LOGGER.info(
