...
import com.sp.backend.boilerplate.constant.Status;
...
public class Response<T> {
     ...
     * @param data
     */
    public Response(@NonNull Status status, @NonNull Integer code, @NonNull T data) {
        this.status = status;
        this.code = code;
        this.data = data;
    }
     ...
     * @param errors
     */
    public Response(@NonNull Status status, @NonNull Integer code, @NonNull ErrorInfo[] errors) {
        this.status = status;
        this.code = code;
        this.errors = errors;
    }
