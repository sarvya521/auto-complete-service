...
public final class ErrorGenerator {
    ...
    public static ErrorDetails generateForCode(String code) {
        return new ErrorDetails(code, ERROR_MESSAGE_SOURCE
            .getMessage(code, null, DEFAULT_MESSAGE, LocaleContextHolder.getLocale()));
    }
    ...
    public static ErrorDetails generateForCodeWithArguments(String code, Object... args) {
        return new ErrorDetails(code, ERROR_MESSAGE_SOURCE
            .getMessage(code, args, DEFAULT_MESSAGE, LocaleContextHolder.getLocale()));
    }
