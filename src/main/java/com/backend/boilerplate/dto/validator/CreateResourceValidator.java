 ...
 */
@Component
public class CreateResourceValidator implements ConstraintValidator<ValidCreateResource, Object> {
    ...
    @Override
    public void initialize(ValidCreateResource constraintAnnotation) {
